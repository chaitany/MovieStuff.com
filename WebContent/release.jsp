...
<head>
<meta charset="utf-8">
<link rel="stylesheet" media="screen" type="text/css" href="css/release.css">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Release Dates</title>
</head>
<body id="bodi">
<img id="anim" src="pictures/About and release title.JPG" alt="website name" height="70" width="220" style="float:right;"/>
<div id='menu'>
<br /><nav>
<ul>
   <li><a href="movie'S'tuff.html"><span>Home</span></a></li>
   <li><a href="movieNews.html"><span>News</span></a></li>
<li class='active'><a href='release.html'><span>Release Dates</span></a></li>
...
<li><form action="release.html" method="get">
<div id="mainContent">
...
<h2 style="position:absolute;left:560px;top:70px;font-family:HighTowerText;font-weight: bold; color:#a62f03;">Movie Release Dates</h2>
<div class="transbox">
<h2>${feedTitle}</h2>  
        ...
        <c:forEach items="${feedItems }" var="feedItem">
        	...
        	<p class="newsLink"><a href="${feedItem.linkUrl }">Link</a></p>
        </c:forEach>

</div>
<p style="position:fixed;bottom:0px;font-size:23px;color:#a62f03;"><a href="about.html">About Us</a>|<a href="Advertise.html">Advertising</a>
</p> 
</body>
</html>  